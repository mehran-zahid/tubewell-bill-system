...
export default function PdfDownloadModal({ isOpen, onClose, onDownloadPdf, isGenerating }) {
  ...
  return (
    <div className="modal-overlay">
      <div className="modal-content" style={{ maxWidth: '400px' }}>
        ...
        <h2 style={{ margin: '0 0 24px 0' }}>Download PDF Summary</h2>
